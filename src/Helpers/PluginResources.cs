namespace Loupedeck.SpotifyNowPlaying
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.MinimalVisiblePlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.MinimalVisiblePlugin.Resources.Resource.txt`.
